...
## What this is
A supervised learning demo that predicts ARIA landmark likelihoods for DOM elements extracted from a website URL, then visualizes top candidates as bounding boxes on a screenshot.
...
- RF probability scores are useful for ranking candidates (top-k) for visualization and clustering.

## Limitations
- Live URL feature extraction approximates the benchmark extraction pipeline; feature drift can affect results.
- Probabilities are confidence scores, not “accuracy”.
